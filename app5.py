...
if st.session_state.submitted:
    ...
    if result.startswith("SELAMAT KAMU ALL ROLE"):
        st.balloons()
        st.image("https://media1.giphy.com/media/v1.Z2lkPTc5MGI3NjExMmdweDRjbDJsa2dvY2xnN2t1d3F4dDI1c29uaW9lNXF1ZWZ5NjZ5MCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/sVnKj2wDhUTsFKFWhx/giphy.gif")
    if st.button("Reset"):
        st.session_state.p_index = 0
        st.session_state.jawaban_user = [None] * len(QUESTIONS)
        st.session_state.submitted = False